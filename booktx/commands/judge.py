...
from booktx.commands.judge_presenters import (
    first_missing_chapter as _first_missing_chapter_impl,
)
from booktx.commands.judge_presenters import (
    print_judge_status_payload as _print_judge_status_payload_impl,
)
from booktx.commands.judge_presenters import (
    print_judge_task as _print_judge_task_impl,
)
from booktx.commands.judge_presenters import (
    render_judge_path as _render_judge_path_impl,
)
from booktx.commands.judge_presenters import (
    render_snapshot_status as _render_snapshot_status_impl,
)
from booktx.commands.judge_presenters import (
    render_status_blockers as _render_status_blockers_impl,
)
from booktx.commands.judge_presenters import (
    sync_render_payload as _sync_render_payload_impl,
)
...
def _render_judge_path(path: Path, runtime: RuntimeContext) -> str:
    return _render_judge_path_impl(path, runtime)
...
def _sync_render_payload(
    ...
    del proj
    return _sync_render_payload_impl(result, runtime, write=write)
...
def _print_judge_task(
    ...
    _print_judge_task_impl(task, proj, runtime, output_format)
