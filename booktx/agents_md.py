...
def _render_isolated_body(*, profile: str, target_locale: str) -> str:
    return (
        ...
        "13. Query exact todo status and inspect `must_continue` / "
        "`next_safe_command`.\n"
        "14. Repeat status/resume in this same assistant turn while the todo is "
        "incomplete; "
        "a successful insert is never a stop condition.\n"
        "15. Stop only when the requested todo is complete or booktx reports a "
        "stop condition.\n"
        "\n"
